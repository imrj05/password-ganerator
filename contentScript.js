...
function createButtonIcon(name) {
  ...
  if (name === 'fill') {
    path.setAttribute('d', 'M8 2v8m0 0 3-3m-3 3L5 7M3 13h10')
  } else if (name === 'copy') {
    path.setAttribute('d', 'M6 5.5h6.5V14H6zM3.5 2H10v2')
  } else if (name === 'refresh') {
    path.setAttribute('d', 'M13 4.5V1.8m0 2.7h-2.7M3.2 11.5A5 5 0 0 0 12 8.7M3 11.5v2.7m0-2.7h2.7M12.8 4.5A5 5 0 0 0 4 7.3')
  } else if (name === 'dismiss') {
    path.setAttribute('d', 'M4 4l8 8M12 4 4 12')
  } else if (name === 'save') {
    path.setAttribute('d', 'M3 2.5h8l2 2V13.5H3zM5.5 2.5v4h5v-4M6 11h4')
  } else if (name === 'never') {
    path.setAttribute('d', 'M8 13a5 5 0 1 0 0-10 5 5 0 0 0 0 10ZM4.5 4.5l7 7')
  } else if (name === 'later') {
    path.setAttribute('d', 'M8 3v5l3 2M13 8A5 5 0 1 1 3 8a5 5 0 0 1 10 0Z')
  } else {
...
function ensureUi() {
  ...
  setButtonIcon(fillButton, 'fill', 'Fill password')
  ...
  fillButton.style.width = '34px'
  fillButton.style.minWidth = '34px'
  const copyButton = document.createElement('button')
  copyButton.type = 'button'
  setButtonIcon(copyButton, 'copy', 'Copy password')
  applyButtonStyles(copyButton, {
    background: 'rgba(255, 255, 255, 0.82)',
    color: '#1f2937',
    border: '1px solid rgba(53, 66, 87, 0.12)'
  }, { stretch: false, height: '34px', padding: '0', borderRadius: '2px', fontSize: '12px' })
  copyButton.style.width = '34px'
  copyButton.style.minWidth = '34px'
  ...
  attachTooltip(fillButton, 'Fill password')
  attachTooltip(copyButton, 'Copy password')
  ...
  setButtonIcon(saveButton, 'save', 'Save login')
  applyButtonStyles(saveButton, {
    background: 'rgba(115, 226, 160, 0.22)',
    color: '#14532d',
    border: '1px solid rgba(34, 197, 94, 0.42)'
  }, { stretch: false, height: '34px', padding: '0', borderRadius: '2px', fontSize: '12px' })
  saveButton.style.width = '34px'
  saveButton.style.minWidth = '34px'
  const neverButton = document.createElement('button')
  neverButton.type = 'button'
  setButtonIcon(neverButton, 'never', 'Never save for this site')
  applyButtonStyles(neverButton, {
    background: 'rgba(255, 255, 255, 0.82)',
    color: '#1f2937',
    border: '1px solid rgba(53, 66, 87, 0.12)'
  }, { stretch: false, height: '34px', padding: '0', borderRadius: '2px', fontSize: '12px' })
  neverButton.style.width = '34px'
  neverButton.style.minWidth = '34px'
  const laterButton = document.createElement('button')
  laterButton.type = 'button'
  setButtonIcon(laterButton, 'later', 'Decide later')
  applyButtonStyles(laterButton, {
    background: 'transparent',
    color: '#6b7280',
    border: '1px solid transparent'
  }, { stretch: false, height: '34px', padding: '0', borderRadius: '2px', fontSize: '12px' })
  laterButton.style.width = '34px'
  laterButton.style.minWidth = '34px'
  ...
  attachTooltip(saveButton, 'Save login')
  attachTooltip(neverButton, 'Never save for this site')
  attachTooltip(laterButton, 'Decide later')
